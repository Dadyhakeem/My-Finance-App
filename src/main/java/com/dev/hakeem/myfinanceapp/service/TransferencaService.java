...
public class TransferencaService {
    ...
    public void transferir(TransferenciaDTO transferenciaDTO) {
        ...
        Optional<Conta> contaOrigemOpt = contaRepository.findById(transferenciaDTO.getOrigem().getId());
        Optional<Conta> contaDestinoOpt = contaRepository.findById(transferenciaDTO.getDestino().getId());
     ...
     */
    private void debitar(Conta origem, double valor) {
